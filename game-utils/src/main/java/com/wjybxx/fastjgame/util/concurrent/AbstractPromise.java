...
import static com.wjybxx.fastjgame.util.ThreadUtils.checkInterrupted;
import static com.wjybxx.fastjgame.util.ThreadUtils.recoveryInterrupted;
...
abstract class AbstractPromise<V> implements Promise<V> {
    ...
    static abstract class Completion implements Runnable {
         ...
         * 2. mode指示可以调用{@link #postComplete(AbstractPromise)}方法时，则直接推送其进入完成状态的事件。
         * <p>
