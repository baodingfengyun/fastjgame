...
public class YieldWaitStrategyFactory implements WaitStrategyFactory {
    ...
    private static final int SPIN_TRIES = com.wjybxx.fastjgame.util.concurrent.disruptor.YieldWaitStrategyFactory.SPIN_TRIES;
    private static final int DEFAULT_LOOP_ONCE_SPIN_TRIES = com.wjybxx.fastjgame.util.concurrent.disruptor.YieldWaitStrategyFactory.DEFAULT_LOOP_ONCE_SPIN_TRIES;
