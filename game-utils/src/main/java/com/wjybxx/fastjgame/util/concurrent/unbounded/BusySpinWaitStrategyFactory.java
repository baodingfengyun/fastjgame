...
public class BusySpinWaitStrategyFactory implements WaitStrategyFactory {
    ...
    private static final int DEFAULT_LOOP_ONCE_SPIN_TRIES = com.wjybxx.fastjgame.util.concurrent.disruptor.BusySpinWaitStrategyFactory.DEFAULT_LOOP_ONCE_SPIN_TRIES;
