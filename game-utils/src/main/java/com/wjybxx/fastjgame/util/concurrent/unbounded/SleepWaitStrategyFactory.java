...
public class SleepWaitStrategyFactory implements WaitStrategyFactory {
    ...
    private static final int DEFAULT_RETRIES = com.wjybxx.fastjgame.util.concurrent.disruptor.SleepWaitStrategyFactory.DEFAULT_RETRIES;
    private static final long DEFAULT_SLEEP_NS = com.wjybxx.fastjgame.util.concurrent.disruptor.SleepWaitStrategyFactory.DEFAULT_SLEEP_NS;
