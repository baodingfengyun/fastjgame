 ...
 */
abstract class AbstractFluentPromise<V> extends AbstractPromise<V> {
    ...
    AbstractFluentPromise(V result) {
        super(result);
    }

    AbstractFluentPromise(@Nonnull Throwable cause) {
        super(cause);
    }
    ...
    static abstract class UniCompletion<V, U> extends Completion {
        ...
        UniCompletion(Executor executor, AbstractPromise<V> input, AbstractPromise<U> output) {
