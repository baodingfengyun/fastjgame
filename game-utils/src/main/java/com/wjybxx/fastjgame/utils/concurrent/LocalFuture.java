 ...
 *
 * <h3>激进优化</h3>
 * 1. 基于假设1，可以消除<b>添加</b>和<b>删除</b>监听器过程中产生的竞争。<br>
 * 2. 基于假设2，我们总是在特定线程下才通知监听器，这样可以有最小的通知开销。<br>
 * 3. 基于假设3，当future进入完成状态时，只是简单的提交一个通知任务，而不需要任何变量判断 <b>是否存在监听器</b>，<b>是否正在通知监听器</b>。
 *
 * <p>
