...
public class ClassScanner {
    ...
    public static Set<Class<?>> findAllClass(String pkgName) {
        return findAllClass(pkgName, clazzName -> true, clazz -> true);
    }
    ...
    public static Set<Class<?>> findAllOuterClass(String pkgName) {
        return findAllClass(pkgName, exceptInnerClass(), clazz -> true);
    }
     ...
     */
    public static Set<Class<?>> findAllClass(String pkgName, Predicate<String> classNameFilter,Predicate<Class<?>> classFilter) {
        //第一个class类的集合
