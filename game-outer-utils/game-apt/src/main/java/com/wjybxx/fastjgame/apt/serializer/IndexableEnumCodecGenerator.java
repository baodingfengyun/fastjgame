 ...
 * date - 2020/2/18
 */
class IndexableEnumCodecGenerator extends AbstractGenerator<SerializableClassProcessor> {

    IndexableEnumCodecGenerator(SerializableClassProcessor processor, TypeElement typeElement) {
