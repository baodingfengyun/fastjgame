...
public class CenterSendMgr {
    ...
    public void sendToScene(long worldGuid, @Nonnull Message msg) {
        SceneInCenterInfo sceneInfo = sceneInCenterInfoMgr.getSceneInfo(worldGuid);
    ...
    public void sendToWarzone(@Nonnull Message msg) {
        WarzoneInCenterInfo warzoneInCenterInfo = warzoneInCenterInfoMgr.getWarzoneInCenterInfo();
