...
import com.wjybxx.fastjgame.core.BackoffRetryForever;
import com.wjybxx.fastjgame.core.CuratorClientMgr;
import com.wjybxx.fastjgame.core.ZKGuidGenerator;
...
public class ZKGuidGeneratorTest {
    ...
    private static void doTest(CuratorClientMgr curatorClientMgr, String name) {
        final ZKGuidGenerator guidGenerator = new ZKGuidGenerator(curatorClientMgr, name);
        try {
