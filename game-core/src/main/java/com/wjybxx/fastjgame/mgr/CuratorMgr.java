...
public class CuratorMgr {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CuratorMgr.class);
    ...
    public CloseableHandle watchChildren(String path, @Nonnull PathChildrenCacheListener listener) throws Exception {
        ...
        pathChildrenCache.getListenable().addListener(listener, gameEventLoopMgr.getEventLoop());
        // 避免外部忘记关闭
