 ...
 */
@ThreadSafe
public class InnerTCPClientChannelInitializer extends ChannelInitializer<SocketChannel> {

    private final int maxFrameLength;
    private final DisruptorMrg disruptorMrg;
    private final CodecHelper codecHelper;

    public InnerTCPClientChannelInitializer(int maxFrameLength, DisruptorMrg disruptorMrg, CodecHelper codecHelper) {
