 ...
 */
@ThreadSafe
public class InnerServerSyncRpcInitializer extends ChannelInitializer<SocketChannel> {

    private final int maxFrameLength;
    private final CodecHelper codecHelper;
    private final SyncS2CSessionMrg syncS2CSessionMrg;

    public InnerServerSyncRpcInitializer(int maxFrameLength, CodecHelper codecHelper, SyncS2CSessionMrg syncS2CSessionMrg) {
