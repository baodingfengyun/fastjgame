 ...
 */
@ThreadSafe
public class InnerTCPServerChannelInitializer extends ChannelInitializer<SocketChannel> {

    private final int maxFrameLength;
    private final CodecHelper codecHelper;
    private final DisruptorMrg disruptorMrg;

    public InnerTCPServerChannelInitializer(int maxFrameLength, CodecHelper codecHelper, DisruptorMrg disruptorMrg) {
