...
package com.wjybxx.fastjgame.initializer;

import com.wjybxx.fastjgame.mrg.sync.SyncC2SSessionMrg;
import com.wjybxx.fastjgame.net.common.BuilderToMessageEncoder;
 ...
 */
@ThreadSafe
public class InnerClientSyncRpcInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public InnerClientSyncRpcInitializer(int maxFrameLength, int pingInterval, CodecHelper codecHelper, SyncC2SSessionMrg syncC2SSessionMrg) {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        // 允许直接发送builder
        pipeline.addLast(new BuilderToMessageEncoder());
    }
}
